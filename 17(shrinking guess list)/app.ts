...
var guestList: string[] = ['bilal', 'Bobby', 'nazish'];
...
const cannotMakeIt: string = 'Bobby';

// Print the name of the guest who can't make it
console.log(`\n${cannotMakeIt} can't make it to the dinner.`);

// Replace the guest who can't make it with a new guest
const newGuest: string = 'nazish';
const index: number = guestList.indexOf(cannotMakeIt); // Find the index of the guest who can't make it
...
// Define the initial list of guests
var guestList: string[] = ['bilal', 'bobby', 'nazish', 'shahani', 'fahad'];
